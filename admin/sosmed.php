...
<div class="w3-modal" style="display: none;" id="sosmedAdd">
    <form action="sosmedAdd.php" method="post" style="margin: 50px 500px; background-color: white; padding: 30px;">
        <button class="cancel w3-btn w3-deep-orange" onclick="document.getElementById('sosmedAdd').style.display='none'">X</button>
...
<div class="w3-modal" style="display: none;" id="sosmedEdit">
    <form action="sosmedEdit.php" method="post" style="margin: 50px 500px; background-color: white; padding: 30px;">
        <button class="cancel w3-btn w3-deep-orange" onclick="document.getElementById('sosmedEdit').style.display='none'">X</button>
...
<div class="isi" style="margin: 0 200px;">
  <button class="w3-btn w3-deep-orange" onclick="document.getElementById('sosmedAdd').style.display='block'">Tambah Akun</button>
