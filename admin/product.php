...
<div class="w3-modal" style="display: none;" id="productAdd">
    <form action="productAdd.php" method="post" enctype="multipart/form-data" style="margin: -35px 450px; background-color: white; padding: 30px 0px 30px 60px;">
        <div class="cancel w3-btn w3-deep-orange" onclick="document.getElementById('productAdd').style.display='none'" style="margin: -30px 0px">X</div>
...
<div class="w3-modal" style="display: none;" id="productEdit">
    <form action="productEdit.php" method="post" enctype="multipart/form-data" style="margin: -35px 450px; background-color: white; padding: 30px 0px 30px 60px;">
        <div class="cancel w3-btn w3-deep-orange" onclick="document.getElementById('productEdit').style.display='none'" style="margin: -30px 0px">X</div>
...
<div class="isi">
  <div class="w3-btn w3-deep-orange" onclick="document.getElementById('productAdd').style.display='block'" style="margin-bottom: 20px">Tambah Produk</div>
