...
<div class="isi">
    <div class="w3-modal" style="display: none;" id="saleAdd">
        <form action="saleAdd.php" method="post" style="margin: 30px 450px; background-color: white; padding: 30px;">
            <button class="cancel w3-btn w3-deep-orange" onclick="document.getElementById('saleAdd').style.display='none'">X</button>
            ...
            <input type="submit" value="Submit" name="addSubmit" onclick="document.getElementById('saleAdd').style.display='none'" class="w3-btn w3-deep-orange"></center>
        </form>
    </div>
    ...
    <div class="w3-modal" style="display: none;" id="saleEdit">
        <form action="saleEdit.php" method="post" style="margin: 30px 450px; background-color: white; padding: 30px;">
            <button class="cancel w3-btn w3-deep-orange" onclick="document.getElementById('saleEdit').style.display='none'">X</button>
            ...
            <input type="submit" value="Submit" name="editSubmit" onclick="document.getElementById('saleEdit').style.display='none'" class="w3-btn w3-deep-orange"></center>
        </form>
    </div>

        <button class="w3-btn w3-deep-orange" style="margin-bottom: 20px;" onclick="document.getElementById('saleAdd').style.display='block'">Tambah Promo</button>
