<div class="header w3-deep-orange">
	...
	<div id="signInGoogle" class="g-signin2" data-onsuccess="onSignIn" data-theme="dark" style="float: right; margin: -5px 0 0 0" onmouseover="menuProfilIn()" onmouseout="menuProfilOut()"></div> 
	<div style="float: right; margin: -10px 80px 0 0; color: white;" class="w3-dropdown-hover">
